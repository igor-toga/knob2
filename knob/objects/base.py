...
"""Knob common internal object model"""
...
class KnobObjectRegistry(ovoo_base.VersionedObjectRegistry):
    pass


class KnobObject(ovoo_base.VersionedObject):
    OBJ_PROJECT_NAMESPACE = 'knob'
    VERSION = '1.0'
