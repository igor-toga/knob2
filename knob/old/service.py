...
from knob.common.i18n import _, _LE, _LI, _LW
from knob import objects
from knob.objects import base as objects_base
...
service_opts = [
    ...
    cfg.StrOpt('knob_listen',
               default="0.0.0.0",
               help='IP address on which OpenStack Knob API listens'),
    cfg.PortOpt('knob_listen_port',
                default=8776,
                help='Port on which OpenStack Knob API listens'),
    cfg.IntOpt('knob_workers',
               default=1,
               help='Number of workers for OpenStack Knob API service. '
...
class Service(service.Service):
    ...
    def start(self):
        ...
        serializer = objects_base.KnobObjectSerializer()
    ...
    def _create_service_ref(self, context, rpc_version=None):
        ...
        kwargs = {
            ...
            'object_current_version': objects_base.OBJ_VERSION,
        }
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'knob-' part
        ...
        if not topic:
            topic = binary
        if not manager:
            subtopic = topic.rpartition('knob-')[2]
...
class WSGIService(service.ServiceBase):
    ...
    def __init__(self, name, loader=None):
        ...
        self.manager = importutils.import_class('knob_manager')
        ctxt = context.get_admin_context()    
        try:
            service_ref = objects.Service.get_by_args(ctxt, host, binary)
            ...
            self._create_service_ref(ctxt, self.manager.RPC_API_VERSION)
